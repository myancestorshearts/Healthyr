    ...
    render() {
        ...
        return (
            <FlexContainer gap='20px'>
                <PortalTitle title='Orders' />

                <FlexContainer gap='10px'>
                    <i
                        style={{ ...STYLES.iconFilter, ...this.state.view == VIEW_DASHBOARD ? STYLES.iconFilterActive : {} }}
                        className='fa fa-dashboard'
                        onClick={() => this.setState({ view: VIEW_DASHBOARD })}
                    />
                    <i
                        style={{ ...STYLES.iconFilter, ...this.state.view == VIEW_TABLE ? STYLES.iconFilterActive : {} }}
                        ...
                        stylescontainer={STYLES.selectContainer} />
                    {
                        this.state.view == VIEW_TABLE ?
                            <InputSelectModel
                                ...
                                stylesselect={STYLES.selectInput}
                                stylescontainer={STYLES.selectContainer} /> : null
                    }
                </FlexContainer>
